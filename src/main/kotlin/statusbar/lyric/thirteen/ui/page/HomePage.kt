...
import statusbar.lyric.thirteen.MainActivity.Companion.isLoad
...
import statusbar.lyric.thirteen.tools.AnimTools
                        ...
                        AnimatedVisibility(
                            ...
                            Column {
                                ...
                                Card(
                                    ...
                                    SuperArrow(
                                        title = stringResource(R.string.island_rule_page),
                                        onClick = {
                                            if (currentRoute != "IslandRulePage") {
                                                navController.navigate("IslandRulePage") {
                                                    popUpTo("HomePage") {
                                                        saveState = true
                                                    }
                                                    launchSingleTop = true
                                        ...
                                        holdDownState = currentRoute == "IslandRulePage"
                                    )
                                }
                            }
                        }
